...
class LoanRequest(models.Model):
    ...
    approval_date = models.DateTimeField(null=True, blank=True)  # تاریخ تأیید وام
...
class LoanPayment(models.Model):
    ...
    def __str__(self):
        return f"{self.loan.user.username} - قسط {self.amount} تومان ({self.payment_date_jalali()})"
